...
def generate(job, data_list, output_dir):
    ...
    with open(data_list, 'r') as f1:
        ...
        for line in content:
            ...
            if os.path.exists(os.path.join(spkpath, name)+ '-pw.wav'):   # + '-pw.wav'):
                continue
...
if __name__ == '__main__':
    ...
    data_list = ['/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/Normal2Whisper/500_split/aa',
                 '/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/Normal2Whisper/500_split/ab',
                 '/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/Normal2Whisper/500_split/ac',
                 '/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/Normal2Whisper/500_split/ad',
                 '/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/Normal2Whisper/500_split/ae',
                 '/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/Normal2Whisper/500_split/af',
                 '/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/Normal2Whisper/500_split/ag',
                 '/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/Normal2Whisper/500_split/ah',]
    output_dir = '/tudelft.net/staff-bulk/ewi/insy/SpeechLab/zhaofenglin/LibriSpeech/train-other-500-pw' 
